package com.refreshrecycle.holder;
...
import com.recycletorefresh.GenericViewHolder;
import com.refreshrecycle.News;
import com.refreshrecycle.R;

/**
 * Created by 魏学军 on 2017/10/30.
 */
public class NewsDataHolder extends DataHolder {

    public NewsDataHolder(Object data, int type) {
        super(data, type);
    }

    @Override
    public GenericViewHolder onCreateView(Context context) {
        View item = LayoutInflater.from(context).inflate(R.layout.item_news,null);
        SimpleDraweeView ivIcon = (SimpleDraweeView) item.findViewById(R.id.ivIcon);
